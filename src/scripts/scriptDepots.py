...
RepBase = os.path.normpath(r"C:\Users\laura\Desktop\Plannification\TP_MCTS\src\test\resources\benchmarks\pddl\ipc2002\depots\strips-automatic")
domaine = os.path.join(RepBase, "domain.pddl")
problemes = ["p01.pddl", "p05.pddl", "p10.pddl"]
# repérer les répertoires des classes et librairies
RepClasses = os.path.normpath(r"C:\Users\laura\Desktop\Plannification\TP_MCTS\classes")
RepLib = os.path.normpath(r"C:\Users\laura\Desktop\Plannification\TP_MCTS\lib\pddl4j-4.0.0.jar")
...
labelsProblemes = ["p01", "p05", "p10"]

plt.figure(figsize=(10, 8)) # taille de la figure
plt.suptitle("Dépôts", fontsize=16) # titre
